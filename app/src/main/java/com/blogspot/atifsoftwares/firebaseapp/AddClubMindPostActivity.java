...
public class AddClubMindPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_club_mind_post);
        ...
        anonymouseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AddClubMindPostActivity.this, "익명으로 작성합니다", Toast.LENGTH_SHORT).show();
                // } 버튼 하나로 하려 했으나 실패....
//                else if(flag == 0) {
//                    flag = 1;
...
//                }
        ...
        username.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Aname = name;
                Toast.makeText(AddClubMindPostActivity.this, "이름으로 작성합니다", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        ref.child(editPostId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        pd.dismiss();
                        Toast.makeText(AddClubMindPostActivity.this, "Updated...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(AddClubMindPostActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void loadPostData(String editPostId) {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("MindPosts1");
    ...
    private void uploadData( final String description) {
        ...
        String filePathAndName = "MindPosts1/" + "post_" + timeStamp;
        ...
        ref.child(timeStamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        //added in database
                        pd.dismiss();
                        Toast.makeText(AddClubMindPostActivity.this, "Post published", Toast.LENGTH_SHORT).show();
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", notificationJo,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //error occurred
                        Toast.makeText(AddClubMindPostActivity.this, ""+error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Override
